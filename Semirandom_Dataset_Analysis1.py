...
summary_4 = Algorithmic_Analysis.runAnalysis("./trial4", target=target4)
summary_4.sort_values(by=['model_name'])
summary_4.to_csv("trial4_target4.csv")


# summary_3 = Algorithmic_Analysis.runAnalysis("./trial4", target=target3)
# summary_3.sort_values(by=['model_name'])
# summary_3.to_csv("trial4_target3.csv")
