...
'''
def cluster_plot(X, clf_names, filepath, markers, labels = [], visualDim = 2, reduceDim = False, dimReduc_method=None, param_dimReduc = {}):   
    #fixes the color for the labels
    palette = {0:"#F23030", 1:"#F2762E", 2:"#F2D338", 3:"#25C7D9", 4:"#248EA6", -1:"#324DBE", 5:"#800080", 6:"#3C005A", 7:"#EABFFF"} 
    ...
    if visualDim == 2:
        ...
        if len(labels) != 0:
            ...
            #print(df)
            sns.scatterplot(data=df, x="x1", y="x2", hue="label", style="clf_name",  legend = "full", s = 100, ax=ax, markers=markers, palette=palette)
