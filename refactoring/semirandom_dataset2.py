...
def decisionTreeSetup():
    ...
    for i in range(1,22):
        ...
        decisionTreeClassifier_generator.get_LDM(X_test, 500, 10, 0.15, "generate_subset_plus_fixed")
        decisionTreeClassifier_generator.compute_PD()
        decisionTreeClassifier_generator.save_state(f"./trial5/trial5_DecisionTree{i}.json", f"DecisionTree{i}", "SemiRandom")
        trial_end = time()
...
def kNNSetup():
    ...
    for i in range(1,22):
        ...
        kNeighborsClassifier_generator.save_state(f"./trial5/trial5_KNN{i}.json", f"KNN{i}", "SemiRandom")
        trial_end = time()
...
def randomForestSetup():
    ...
    for i in range(1,22):
        ...
        randomForest_generator.save_state(f"./trial5/trial5_RandomForest{i}.json", f"RandomForest{i}", "SemiRandom")
        trial_end = time()
...
def adaboostSetup():
    ...
    adaboostClassifier50_generator.save_state(f"./trial5/trial5_Adaboost50.json", f"Adaboost50", "SemiRandom")
    end = time()
...
def QDASetup():
    ...
    quadraticDiscriminantAnalysis_generator.save_state(f"./trial5/trial5_QuadraticDiscriminantAnalysis.json", f"QuadraticDiscriminantAnalysis", "SemiRandom")
    end = time()
...
def gaussianProcessSetup():
    ...
    gaussianProcessClassifier_generator.save_state(f"./trial5/trial5_GaussianProcessClassifier.json", f"GaussianProcessClassifier", "SemiRandom")
    end = time()
...
def naiveBayesClassifierSetup():
    ...
    naiveBayesClassifier_generator.save_state(f"./trial5/trial5_NaiveBayesClassifier.json", f"NaiveBayesClassifier", "SemiRandom")
    end = time()
...
def linearSVCSetup():
    ...
    linearSVC_generator.save_state(f"./trial5/trial5_LinearSVC.json", f"LinearSVC", "SemiRandom")
    end = time()
...
def logisticRegressionSetup():
    ...
    logisticRegression_generator.save_state(f"./trial5/trial5_LogisticRegression.json", f"LogisticRegression", "SemiRandom")
    end = time()
