...
def decisionTreeSetup():
    ...
    for i in range(1,22):
        ...
        decisionTreeClassifier_generator.save_state(f"./logs/trial2_DecisionTree{i}.json", f"DecisionTree{i}", "FullySynthetic")
        trial_end = time()
...
def kNNSetup():
    ...
    for i in range(1,22):
        ...
        kNeighborsClassifier_generator.save_state(f"./logs/trial2_KNN{i}.json", f"KNN{i}", "FullySynthetic")
        trial_end = time()
...
def randomForestSetup():
    ...
    for i in range(1,22):
        ...
        randomForest_generator.save_state(f"./logs/trial2_RandomForest{i}.json", f"RandomForest{i}", "FullySynthetic")
        trial_end = time()
...
def adaboostSetup():
    ...
    adaboostClassifier50_generator.save_state(f"./logs/trial2_Adaboost50.json", f"Adaboost50", "FullySynthetic")
    end = time()
...
def QDASetup():
    ...
    quadraticDiscriminantAnalysis_generator.save_state(f"./logs/trial2_QuadraticDiscriminantAnalysis.json", f"QuadraticDiscriminantAnalysis", "FullySynthetic")
    end = time()
...
def gaussianProcessSetup():
    ...
    gaussianProcessClassifier_generator.save_state(f"./logs/trial2_GaussianProcessClassifier.json", f"GaussianProcessClassifier", "FullySynthetic")
    end = time()
...
def naiveBayesClassifierSetup():
    ...
    naiveBayesClassifier_generator.save_state(f"./logs/trial2_NaiveBayesClassifier.json", f"NaiveBayesClassifier", "FullySynthetic")
    end = time()
...
def linearSVCSetup():
    ...
    linearSVC_generator.save_state(f"./logs/trial2_LinearSVC.json", f"LinearSVC", "FullySynthetic")
    end = time()
...
def logisticRegressionSetup():
    ...
    logisticRegression_generator.save_state(f"./logs/trial2_LogisticRegression.json", f"LogisticRegression", "FullySynthetic")
    end = time()
