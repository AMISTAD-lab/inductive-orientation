...
def decisionTreeSetup():
    ...
    for i in range(1,22):
        ...
        decisionTreeClassifier_generator.save_state(f"./trial6/trial6_DecisionTree{i}.json", f"DecisionTree{i}", "SemiRandom")
        trial_end = time()
...
def kNNSetup():
    ...
    for i in range(1,22):
        ...
        kNeighborsClassifier_generator.save_state(f"./trial6/trial6_KNN{i}.json", f"KNN{i}", "SemiRandom")
        trial_end = time()
...
def randomForestSetup():
    ...
    for i in range(1,22):
        ...
        randomForest_generator.save_state(f"./trial6/trial6_RandomForest{i}.json", f"RandomForest{i}", "SemiRandom")
        trial_end = time()
...
def adaboostSetup():
    ...
    adaboostClassifier50_generator.save_state(f"./trial6/trial6_Adaboost50.json", f"Adaboost50", "SemiRandom")
    end = time()
...
def QDASetup():
    ...
    quadraticDiscriminantAnalysis_generator.save_state(f"./trial6/trial6_QuadraticDiscriminantAnalysis.json", f"QuadraticDiscriminantAnalysis", "SemiRandom")
    end = time()
...
def gaussianProcessSetup():
    ...
    gaussianProcessClassifier_generator.save_state(f"./trial6/trial6_GaussianProcessClassifier.json", f"GaussianProcessClassifier", "SemiRandom")
    end = time()
...
def naiveBayesClassifierSetup():
    ...
    naiveBayesClassifier_generator.save_state(f"./trial6/trial6_NaiveBayesClassifier.json", f"NaiveBayesClassifier", "SemiRandom")
    end = time()
...
def linearSVCSetup():
    ...
    linearSVC_generator.save_state(f"./trial6/trial6_LinearSVC.json", f"LinearSVC", "SemiRandom")
    end = time()
...
def logisticRegressionSetup():
    ...
    logisticRegression_generator.save_state(f"./trial6/trial6_LogisticRegression.json", f"LogisticRegression", "SemiRandom")
    end = time()
